...
import cpImage from "../../Assets/Shadow Game.png"
            ...
            <div className='flex flex-col justify-center items-center gap-6 mt-6'>
                <div className='w-[400px] flex flex-col bg-black justify-center items-center gap-4  p-4 rounded-xl'>
                    <div className='w-[150px] h-[150px] '>
                        <img src={cpImage} className=' object-cover '/>
                    </div>
                    <div className='flex flex-col justify-center items-center gap-2'>
                        <h2 className='sm:text-2xl text-xl text-darkYellow text-center'>Chetanya Pathak</h2>
