...
import flappyBird_poster from "../Assets/Flappy Bird/FlappyBirdbig.jpeg"
    ...
    return (
        <div className='w-full flex flex-col justify-center items-center bg-bgGradientColor'>
            <div className='w-11/12 mb-[3rem]'>
                ...
                <div>
                    <AllGames
                        poster={flappyBird_poster}
                        direction={"right"}
                        link={"/flappyBird"}
                        video={flappyBirdVideo}
                        videoHad={"Dive into the World of Flappy Bird: Learn How to Soar with Our Video Guide!"}
                        videoPara={"In this video, you'll discover:"}
                        point1={"The basics of Flappy Bird gameplay"}
                        point2={"Tips for navigating obstacles and earning points"}
                        point3={"Strategies for achieving high scores"}
                        point4={"Advanced techniques for mastering the game and reaching new heights"}
                        gameHad={"Soar to New Heights: Play Flappy Bird Now!"}
                        gamePara1={"Experience the addictive fun of Flappy Bird, where every tap takes you closer to victory. Guide your feathered friend through a series of obstacles, test your reflexes, and see how far you can fly."}
                        gamePara2={"In Flappy Bird, precision is key. Will you navigate the maze of pipes with ease, or will you meet your feathered fate? With its simple yet challenging gameplay, Flappy Bird offers endless hours of entertainment for players of all ages."}
                    />
                </div>
                {/*  <div>
                    <AllGames 
